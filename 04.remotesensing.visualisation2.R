# In this code snippet, the necessary packages are installed and loaded for remote sensing analysis. 
...
#  The 'devtools' and 'terra' packages are loaded for package installation and spatial data handling.

# Install the 'imageRy' package from GitHub using 'devtools'
devtools::install_github("ducciorocchini/imageRy")

# The 'imageRy' package is installed from GitHub using 'devtools'.

# Load the 'imageRy' package
library(imageRy)

# The 'imageRy' package is loaded for remote sensing analysis.
...
#  The blue band from Sentinel-2 (band 2) is imported and assigned to the variable 'b2'.
